...
public class EmptyTag extends AbstractElementProcessor {

	private static final int PRECEDENCE = 10000;// 优先级

	public EmptyTag(String elementName) {
		super(elementName);
	}

	@Override
	protected ProcessorResult processElement(final Arguments arguments, final Element element) {
		final boolean visible = isEmpty(arguments, element);
	...
	protected boolean isEmpty(final Arguments arguments, final Element element) {
